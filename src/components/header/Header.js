     ...
     const MaterialUISwitch = styled(Switch)(({theme}) => ({
         ...
         '& .MuiSwitch-switchBase': {
             ...
             '&.Mui-checked': {
                 ...
                 '& + .MuiSwitch-track': {
                     opacity: 1,
                     backgroundColor: theme.palette.mode === 'dark' ? '#00AE84' : '#00AE84',
                 },
             },
         },
         '& .MuiSwitch-thumb': {
                ...
                <div className="container">
                    <div className="header-general flex  justify-between items-center">
                        ...
                        <div className="flex items-center">
                            ...
                            <a href="#" className="header-general__nav pl-12 text-white  ">О нас</a>
                            ...
                            <button className="header-general__btn pl-10 ">
                                {/*<FontAwesomeIcon icon="fa-solid fa-phone-volume" />*/}
                                <img src={tell} alt="tel" className="absolute header-general__tell"/>
